...
import ir.msob.manak.chat.model.huggingface.HuggingFaceProviderService;
import ir.msob.manak.chat.model.ollama.OllamaProviderService;
...
public class ModelProviderHubService {
    ...
    public static final String HUGGING_FACE_TYPE = "HuggingFace";
    ...
    private final HuggingFaceProviderService huggingFaceProviderService;
    ...
    public ModelProviderService getProvider(String type) {
        ...
        } else if (HUGGING_FACE_TYPE.equalsIgnoreCase(type)) {
            return huggingFaceProviderService;
        }
